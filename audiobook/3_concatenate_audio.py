...
FINAL_UNMASTERED = OUTPUT_DIR / "Miserable_Audiobook_Unmastered.wav"
FINAL_MASTERED = AUDIOBOOK_DIR / "Miserable_Audiobook_Complete.wav"
...
def concatenate_audiobook():
    ...
    wav_files = [f for f in wav_files if f.name.endswith('.wav') and not f.name.startswith('Miserable')]
