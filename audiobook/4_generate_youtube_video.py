...
AUDIO_FILE = AUDIOBOOK_DIR / "Miserable_Audiobook_Complete.wav" # Look in root
SPLASH_IMAGE = AUDIOBOOK_DIR / "audiobook_splash_screen.png"
OUTPUT_VIDEO = AUDIOBOOK_DIR / "output" / "Miserable_Audiobook_YouTube.mp4" # Put in output
