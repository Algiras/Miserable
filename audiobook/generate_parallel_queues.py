#!/usr/bin/env python3
"""
Miserable Parallel Queue Pipeline
...
class PipelineManager:
    ...
    def run(self):
        print("\n" + "🚀" * 30)
        print("MISERABLE PARALLEL STREAMING PIPELINE")
        print("🚀" * 30 + "\n")
    ...
    def assemble_final_product(self):
        ...
        master_audio = AUDIOBOOK_DIR / "Miserable_Audiobook_Complete.wav"
        splash = AUDIOBOOK_DIR / "audiobook_splash_screen.png"
        video_out = OUTPUT_DIR / "output" / "Miserable_Audiobook_YouTube.mp4"
        
        if generate_video(master_audio, splash, video_out):
            # 4. Burn in Captions
            final_srt = OUTPUT_DIR / "Miserable_Audiobook_Complete.srt"
            captioned_video = OUTPUT_DIR / "Miserable_Audiobook_YouTube_captioned.mp4"
    ...
    def merge_srt_files(self):
        ...
        master_srt = OUTPUT_DIR / "Miserable_Audiobook_Complete.srt"
